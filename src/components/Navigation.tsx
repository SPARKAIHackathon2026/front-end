      ...
      >
        ...
        >
          <div className="flex items-center justify-between">
            ...
            >
              <div className="w-8 h-8 rounded-lg bg-[#3898EC] flex items-center justify-center group-hover:glow-blue transition-all">
            ...
            <div className="hidden md:flex items-center gap-8">
              {navLinks.map((link) => (
                ...
                >
                  {link.label}
                  <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-[#3898EC] transition-all group-hover:w-full" />
                </button>
              ))}
            </div>
          ...
          <div className="flex flex-col gap-4">
            {navLinks.map((link) => (
              <button
                key={link.href}
                onClick={() => scrollToSection(link.href)}
                className="text-left text-white/80 hover:text-[#3898EC] py-3 px-4 rounded-lg hover:bg-white/5 transition-all"
              >
                {link.label}
              </button>
            ))}
